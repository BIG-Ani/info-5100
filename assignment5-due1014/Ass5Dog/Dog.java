...
public class Dog extends Pet implements Boardable {
    ...
    public Dog(String ownerName, String petName, String color, String size) {
    ...
    public String toString() {
        ...
        return "\n" + str1 + str2 + "Size: " + getSize();
    }

    //@Test
    public static void main(String[] args) {
        Dog dog = new Dog("Sussan", "Spot", "White", "medium");
        dog.setSex(SexEnum.SPAYED.sexId);
